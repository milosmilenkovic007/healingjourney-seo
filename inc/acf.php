...
add_action('init', function() {
  ...
  acf_add_local_field_group([
    ...
    'title' => 'Site Details',
    'fields' => [
      [ 'key' => 'field_hjseo_domain', 'label' => 'Domain', 'name' => 'domain', 'type' => 'text', 'required' => 1 ],
      [ 'key' => 'field_hjseo_logo', 'label' => 'Logo', 'name' => 'logo', 'type' => 'image', 'return_format' => 'array' ],
      [ 'key' => 'field_hjseo_authority', 'label' => 'Authority Score', 'name' => 'authority_score', 'type' => 'number', 'min' => 0, 'max' => 100 ],
      [ 'key' => 'field_hjseo_backlinks', 'label' => 'Backlinks', 'name' => 'backlinks', 'type' => 'number', 'min' => 0 ],
      [ 'key' => 'field_hjseo_refdomains', 'label' => 'Referring Domains', 'name' => 'referring_domains', 'type' => 'number', 'min' => 0 ],
      [ 'key' => 'field_hjseo_keywords', 'label' => 'Keywords', 'name' => 'keywords_count', 'type' => 'number', 'min' => 0 ],
      [ 'key' => 'field_hjseo_visibility', 'label' => 'Visibility %', 'name' => 'visibility', 'type' => 'number', 'min' => 0, 'max' => 100, 'step' => 0.1 ],
    ],
  ...
  acf_add_local_field_group([
    ...
    'fields' => [
      [ 'key' => 'field_hjseo_report_site', 'label' => 'Site', 'name' => 'site', 'type' => 'post_object', 'post_type' => ['seo_site'], 'return_format' => 'id', 'required' => 1 ],
  ...
  acf_add_local_field_group([
    ...
    'title' => 'Keyword Map',
    'fields' => [
      [ 'key' => 'field_hjseo_kwmap_site', 'label' => 'Site', 'name' => 'site', 'type' => 'post_object', 'post_type' => ['seo_site'], 'return_format' => 'id', 'required' => 1 ],
  ...
  acf_add_local_field_group([
    ...
    'title' => 'Content Plan',
    'fields' => [
      [ 'key' => 'field_hjseo_cp_site', 'label' => 'Site', 'name' => 'site', 'type' => 'post_object', 'post_type' => ['seo_site'], 'return_format' => 'id', 'required' => 1 ],
